...
async function continueConversation(prpt) {
    ...
    const prewrittenPrompts = [
      ...
      "Now, identify hard words that the audience might fail to understand. Create a list of these words as the audience will be aged 2 to 5. Replace these words with easier alternatives that young children will understand."
        ...
        // `Now create a Javascript array named 'story_scenario'.Just give me the array object 'story' in Javascript format. Do not say anything else.Also create a title of the story and give me the title as a javascript string called "Title" and the "Title" would be in these format Title = "/title_text./"`
        // "I will now use stable diffusion to make a scenario from each of the line. Can you make the exact prompt I will send to stable diffusion from each line?",
        // "Double check if you have given me all the lines.",
